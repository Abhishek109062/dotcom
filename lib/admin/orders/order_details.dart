...
import 'package:dot_com/admin/orders/viewModel/order_details_admin_viewModel.dart';
...
class OrdersDetailsPage extends StatefulWidget {
  ...
  static Route<bool> route(int orderId) => MaterialPageRoute<bool>(
      builder: (_) => ChangeNotifierProvider(
            create: (BuildContext context) => OrderDetailsAdminViewModel(orderId: orderId),
            child: OrdersDetailsPage(),
          ));

  @override
  State<OrdersDetailsPage> createState() => _OrdersDetailsState();
}

class _OrdersDetailsState extends State<OrdersDetailsPage> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<OrderDetailsAdminViewModel>(context, listen: false).getOrderDetails();
    });
  }
  ...
  String formatDateFromMilliseconds(int millisecondsSinceEpoch) {
    ...
    // Format the DateTime object as "14 February 2024"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<OrderDetailsAdminViewModel>(
