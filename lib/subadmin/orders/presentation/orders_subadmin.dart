...
import 'package:dot_com/subadmin/orders/presentation/order_details_subadmin.dart';
...
import '../viewModel/order_home_sub_admin_viewModel.dart';

class OrdersPageSubAdmin extends StatefulWidget {
  const OrdersPageSubAdmin({super.key});
  static Route<bool> route() => MaterialPageRoute<bool>(
      builder: (_) => ChangeNotifierProvider(
            create: (BuildContext context) => OrderHomeViewModelSubAdmin(),
            child: OrdersPageSubAdmin(),
          ));
  @override
  State<OrdersPageSubAdmin> createState() => _OrdersPageSubAdminState();
}

class _OrdersPageSubAdminState extends State<OrdersPageSubAdmin> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<OrderHomeViewModelSubAdmin>(context, listen: false).getAllOrders();
      _scrollController.addListener(() =>
          Provider.of<OrderHomeViewModelSubAdmin>(context, listen: false)
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Consumer<OrderHomeViewModelSubAdmin>(
              builder: (context, provider, child) {
                return Container(
                  ...
                  child: ListTile(
                    ...
                    trailing:provider.searched ?GestureDetector(
                        onTap: () {
                          provider.clearSearch();
                        },
                        child: Icon(Icons.close)) : GestureDetector(
                        onTap: () {
  ...
  Widget orderItem(OrderDetailsAdmin order) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(OrdersDetailsPageSubAdmin.route(order.id));
      },
      child: Padding(
