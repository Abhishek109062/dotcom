...
class OrderHomeViewModelSubAdmin extends ChangeNotifier {
  ...
  void searchOrder()async{
    resetPage();
    await getAllOrders(searchString: searchController.text);
    searched = true;
    notifyListeners();
  }
  ...
  Future<void> getAllOrders({String? searchString}) async {
    setLoading(true);
