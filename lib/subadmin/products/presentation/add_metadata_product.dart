...
import '../viewModel/add_metadata_viewModel.dart';

class AddMetadataPage extends StatefulWidget {
  const AddMetadataPage({super.key});

  static Route<bool> route(int productId) => MaterialPageRoute<bool>(
      builder: (_) => ChangeNotifierProvider(
            create: (BuildContext context) => AddMetadataViewModel(productId: productId),
            child: AddMetadataPage(),
          ));

  @override
  State<AddMetadataPage> createState() => _AddMetadataPageState();
}

class _AddMetadataPageState extends State<AddMetadataPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  title: Text(
                    "Products/ Update Product/ Add Metadata",
                    overflow: TextOverflow.ellipsis,
                ...
                Consumer<AddMetadataViewModel>(
                  builder: (context, provider, child) {
                    return AbsorbPointer(
                      absorbing: provider.addingMetadata,
                      child: Form(
                        key: _formKey,
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
      ...
      bottomSheet: Consumer<AddMetadataViewModel>(
        builder: (context, provider, child) {
          return Container(
            ...
            child: Row(
              children: [
                Expanded(
                    child: TextButton(
                        onPressed: () async {
                          await provider.addMetaData(() {
                            snackBarCustom(context, "Metadata Created Successfully");
